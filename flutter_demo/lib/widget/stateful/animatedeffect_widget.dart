          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                margin: const EdgeInsets.symmetric(vertical: 10.0),
                child: const Text(
                  '相关属性变化时具有动画效果的PhysicalModel组件，本质是PhysicalModel和动画结合的产物。可指定阴影、影深、圆角、动画时长、结束回调等属性。',
                  style: descStyle,
                ),
              ),
              Switch(
              ...
              Container(
                ...
                child: AnimatedPhysicalModel(
                  ...
                  // 圆角
                  borderRadius:
                      BorderRadius.all(Radius.circular(flag ? 10 : 75)),
                  // 裁剪但不应用抗锯齿
              ...
              Container(
                margin: const EdgeInsets.symmetric(vertical: 10.0),
                child: const Text(
                  '主题变化时具有动画效果的组件，本质是Theme组件和动面结合的产物。可指定ThemeData、动面时长、曲线、结束回调等。相当于增强版的Theme组件。',
                  style: descStyle,
                ),
              ),
              Switch(
