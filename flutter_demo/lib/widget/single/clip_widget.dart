        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              ClipPath(
                clipper: ShapeBorderClipper(shape: _StartShapeBorder()),
                child: Image.asset(
                  'images/bg.jpg',
                  width: 150,
                  height: 100,
...
class _StartShapeBorder extends ShapeBorder {
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) =>
      nStartPath(20, rect.height / 2, rect.height / 2 * 0.85,
  ...
  Path nStartPath(int num, double R, double r, {dx = 0, dy = 0}) {
